      ...
      <AnimatePresence>
        {open ? (
          <Dialog.Portal forceMount>
            <Dialog.Overlay className="fixed inset-0 max-md:hidden" />
            <Dialog.Content
              className="no-scrollbar fixed right-0 top-0 z-50 h-[100dvh] w-full overflow-y-auto bg-white px-2 pb-1.5 pt-[5rem] md:w-[21.5rem]"
              forceMount
            >
