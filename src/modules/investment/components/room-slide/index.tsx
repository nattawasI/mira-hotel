...
const RoomSlide = (): JSX.Element => {
  return (
    <Splide
      className="aspect-square overflow-hidden rounded-xl md:aspect-video lg:aspect-square lg:flex-1"
      options={{
        arrows: false,
        classes: {
    ...
    >
      {imageList.map((item, index) => (
        ...
        >
          ...
          <button type="button" className="absolute right-0.75 top-0.75 z-10 text-white">
